...
public class Modelv1<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "v1"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(40, 16)
						.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(46, 36)
						.addBox(-1.5F, 6.0F, -1.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-6.0F, 0.0F, 0.0F));

		PartDefinition cube_r1 = RightArm.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-0.5F, -0.25F, -1.25F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(27, 0)
						.addBox(-0.5F, -1.25F, 0.75F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(34, 1)
						.addBox(-0.5F, -4.25F, -0.25F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 11.25F, -0.25F, 0.0F, 0.0F, 0.0F));
		...
		PartDefinition cube_r2 = LeftArm.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(11.5F, -0.25F, -1.25F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(27, 0)
						.addBox(11.5F, -1.25F, 0.75F, 1.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(34, 1)
						.addBox(11.5F, -4.25F, -0.25F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)),
