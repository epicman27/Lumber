	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-4.0F, 0.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(32, -8)
						.addBox(4.0F, -2.0F, -4.0F, 0.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(32, -8)
						.addBox(-4.0F, -2.0F, -4.0F, 0.0F, 2.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition rightfrontleg = partdefinition.addOrReplaceChild("rightfrontleg",
				CubeListBuilder.create().texOffs(16, 16)
						.addBox(-2.8333F, -0.5F, -1.1667F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(2, 2)
						.addBox(-1.8333F, -1.5F, -1.1667F, 3.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(5.8333F, 19.5F, -5.8333F));

		PartDefinition cube_r2 = rightfrontleg.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(2, 2).addBox(-7.0F, -6.0F, -7.0F, 3.0F, 1.0F, 0.0F,
		...
		PartDefinition leftfrontleg = partdefinition.addOrReplaceChild("leftfrontleg", CubeListBuilder.create()
				.texOffs(0, 16).addBox(-2.8333F, -0.5F, -2.8333F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(5.8333F, 19.5F, 5.8333F));
		...
		PartDefinition cube_r4 = leftfrontleg.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(2, 2).addBox(4.0F, -6.0F, -7.0F, 3.0F, 1.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.8333F, 4.5F, -5.8333F, 0.0F, -1.5708F, 0.0F));

		PartDefinition rightbackleg = partdefinition.addOrReplaceChild("rightbackleg",
				CubeListBuilder.create().texOffs(0, 26)
						.addBox(-1.1667F, -0.5F, -1.1667F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(2, 2)
						.addBox(-1.1667F, -1.5F, -1.1667F, 3.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-5.8333F, 19.5F, -5.8333F));

		PartDefinition cube_r5 = rightbackleg.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(2, 2).addBox(-7.0F, -6.0F, 7.0F, 3.0F, 1.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.8333F, 4.5F, 5.8333F, 0.0F, -1.5708F, 0.0F));

		PartDefinition leftbackleg = partdefinition.addOrReplaceChild("leftbackleg", CubeListBuilder.create()
				.texOffs(16, 26).addBox(-1.1667F, -0.5F, -2.8333F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-5.8333F, 19.5F, 5.8333F));
