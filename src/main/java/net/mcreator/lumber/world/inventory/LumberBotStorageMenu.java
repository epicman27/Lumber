...
package net.mcreator.lumber.world.inventory;
...
public class LumberBotStorageMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public LumberBotStorageMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(LumberModMenus.LUMBER_BOT_STORAGE.get(), id);
