...
@Mod("lumber")
public class LumberMod {
	public static final Logger LOGGER = LogManager.getLogger(LumberMod.class);
	...
	public LumberMod() {
		...
		LumberModBlocks.REGISTRY.register(bus);

		LumberModItems.REGISTRY.register(bus);
