...
public class OakLogStairsBlock extends Block implements SimpleWaterloggedBlock {
	...
	public OakLogStairsBlock() {
		...
		this.registerDefaultState(this.stateDefinition.any().setValue(FACING, Direction.NORTH).setValue(FACE, AttachFace.WALL).setValue(STAIRS_SHAPE, STAIRS_SHAPE.getValue("straight").get()).setValue(WATERLOGGED, false));
	}
	...
	protected void createBlockStateDefinition(StateDefinition.Builder<Block, BlockState> builder) {
		...
		builder.add(FACING, FACE, STAIRS_SHAPE, WATERLOGGED);
	}

	@Override
	public BlockState getStateForPlacement(BlockPlaceContext context) {
		boolean flag = context.getLevel().getFluidState(context.getClickedPos()).getType() == Fluids.WATER;
		return super.getStateForPlacement(context).setValue(FACE, faceForDirection(context.getNearestLookingDirection())).setValue(FACING, context.getHorizontalDirection().getOpposite()).setValue(STAIRS_SHAPE, STAIRS_SHAPE.getValue("straight").get())
